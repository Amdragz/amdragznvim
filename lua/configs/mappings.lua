...
map("n", "<Leader>\\", "<cmd>vsplit<CR>", { desc = "Creates a new vertical split" })
map("n", "<Leader>-", "<cmd>split<CR>", { desc = "Creates a new vertical split" })
map(
	"n",
	"<leader>tt",
...
map("n", "<leader>fR", "<cmd>FlutterHotRestart<CR>", { desc = "Flutter Restart" })
...
map("n", "]t", function()
	require("todo-comments").jump_next({ keywords = { "ERROR", "WARNING", "TODO", "FIX", "NOTE" } })
end, { desc = "Next error/warning todo comment" })

map("n", "<leader>td", "<cmd>TodoTelescope<CR>", { desc = "uses telescope to find todo" })
